...
<x-page-header title="إضافة مادة دراسية">
    <x-slot:actions>
        <a href="{{ route('admin.subjects.index') }}" class="btn btn-secondary btn-sm"><i class="fas fa-arrow-right"></i> رجوع للقائمة</a>
    </x-slot:actions>
</x-page-header>
        ...
        <form action="{{ route('admin.subjects.store') }}" method="POST">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="مثال: اللغة العربية">
                    @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-6">
                    <label for="code" class="form-label small fw-bold">رمز المادة <span class="text-danger">*</span></label>
                    <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code') }}" required placeholder="مثال: ARB" dir="ltr">
                ...
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="2" placeholder="نبذة عن المنهج الدراسي...">{{ old('description') }}</textarea>
                </div>
            </div>
            ...
            <p class="text-muted small mb-3">اختر الصفوف التي تُدرَّس فيها هذه المادة:</p>
            ...
            <div class="d-flex justify-content-end gap-2 mt-4">
                ...
                <button type="submit" class="btn btn-primary px-4"><i class="fas fa-save me-2"></i> حفظ المادة</button>
            </div>
        </form>
    </div>
</div>
