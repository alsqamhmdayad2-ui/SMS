...
@section('content')
    ...
    <x-breadcrumb :items="[
        ['name' => 'لوحة التحكم', 'url' => route('parent.dashboard')],
    ...
    <div class="card mb-4 shadow-sm border-0 slide-up">
        <div class="card-body">
            <form action="{{ route('parent.academic-history') }}" method="GET" class="row align-items-end" id="childSelectForm">
                <div class="col-md-6">
    ...
    @if($selectedChild)
    <div class="row slide-up" style="animation-delay: 0.1s;">
        <div class="col-12">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-history text-primary me-2"></i> التسلسل الأكاديمي: {{ $selectedChild->name }}
                    </h5>
                </div>
                <div class="card-body p-4">
                    ...
                    @empty
                        <div class="text-center py-5 text-muted">
                            ...
                            <p>لم يتم العثور على أي بيانات تسجيل سابقة لهذا الابن في النظام.</p>
                        </div>
                    @endforelse
                </div>
            </div>
